...
<%--            <input type="submit" value="修改" formaction="<%=request.getContextPath()%>/SalaryUpdateServlet"></div>--%>
<%--    </div>--%>
<%--</form>--%>
<%--</body>--%>
<%--</html>--%>
...
<div class="right">
    <form style="line-height: 50px;font-family: 华文宋体;font-size: 30px;margin-top: 80px;margin-left: 50px">
        ...
        <input formaction="<%=request.getContextPath()%>/SalaryUpdateServlet" type="submit" style="float: left;height:80px;margin-top: 50px;margin-left:35%;background-color: #2D93CA;cursor: pointer" >
    </form>
</div>
</body>
</html>
